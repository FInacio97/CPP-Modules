...
# define WARNING_1 "I think I deserve to have some extra bacon for free."
# define WARNING_2 "I’ve been coming for years whereas you started working here since last month."
